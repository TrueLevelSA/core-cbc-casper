...
implement the AbstractMsg trait in order to benefit from the casper-cbc safety
...
One generic type implementing the AbstractMsg trait, namely Message, is also
provided that helps getting to a compliant AbstractMsg trait easily.
